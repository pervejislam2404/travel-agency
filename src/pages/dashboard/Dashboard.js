        ...
        <div>
            <div className="container mt-3">
                 <div className="row border">
                     <div className="col-12 col-md-3 col-lg-3">
                        <ul className="list-group border-0">
                            ...
                            {admin && <li className="list-group-item px-0 border-0 fs-5">  
                                <NavLink className={({ isActive }) => (isActive ? 'text-decoration-none text-light px-3 py-1 bg-dark d-block' : 'text-decoration-none text-dark px-3 py-1  d-block')} to="/dashboard/manageProducts"><i className="fas fa-list-alt px-2"></i> Manage User Blogs</NavLink>
                            </li>}
                     ...
                     {/* all-dashboard-route */}
                     <div className="col-12 col-md-9 col-lg-9 border">
                         <Outlet/>
                     </div>
                 </div>
            </div>
